...
class KNearestNeighbor:
    ...
    def compute_distances_no_loops(self, X):
        ...
        #########################################################################
        # *****START OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
        dists = (np.reshape(np.dot(X, np.transpose(X)).diagonal(), \
                                   (num_test, 1))**0.5 +\
        np.reshape(np.dot(self.X_train, np.transpose(self.X_train)).diagonal(), \
                     (1, num_train))  -\
    ...
    def predict_labels(self, dists, k=1):
        ...
        for i in range(num_test):
            ...
            closest_y = [self.y_train[ind] for ind in k_nearest]
            # *****END OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
            #########################################################################
            # TODO:                                                                 #
        ...
        return y_pred.reshape((num_test,))
